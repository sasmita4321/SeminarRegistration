                ...
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        ...
                        <div class='panel-body'>
							...
							$tp=mysql_query("SELECT * FROM registrasi WHERE status='PS' ORDER BY id_regist DESC");
							...
							$jum3= mysql_num_rows(mysql_query("SELECT * FROM tb_makalah WHERE nik='$rs[nik]'"));
                                       ...
                                       echo" <tr class='odd gradeX'>
                                            ...
                                            <td><form method=POST action='$aksi?p=pps&aksi=detail&id=$rs[nik]'>
            ...
            <div class='container-fluid'>
                <div class='row'>
                    <div class='col-lg-12'>
					   ...
					   <table width='100%'>					
					   <tr>  
					   <td width='30%'><p class='text-primary'>NIK</p></td>                                          <td><p class='text-muted'>:&nbsp; $rs[nik]</p></td>											</tr>											<tr>                                          <td><p class='text-primary'>Nama Lengkap</p></td>                                          <td><p class='text-muted'>:&nbsp; $rs[nama]</p></td>											</tr>																																	<tr>                                          <td><p class='text-primary'>Alamat</p></td>                                          <td><p class='text-muted'>:&nbsp; $rs[alamat]</p></td>											</tr>											<tr>											                                          <td><p class='text-primary'>Email</p></td>                                          <td><p class='text-muted'>:&nbsp; $rs[email]</p></td>											</tr>											<tr>											                                          <td><p class='text-primary'>No. Handphone</p></td>                                          <td><p class='text-muted'>:&nbsp; $rs[handphone]</p></td>											</tr>											<tr>											                                          <td colspan='2'><p class='text-muted'><h4>Konfirmasi Pembayaran :</h4></p></td>";                                         $tizs=(mysql_query("SELECT * FROM konfir_bayar WHERE nik='$_GET[id]'"));							$rst=mysql_fetch_array($tizs);											echo"</tr>";											$jum6= mysql_num_rows(mysql_query("SELECT * FROM konfir_bayar WHERE nik='$_GET[id]'"));											if ($jum6==0){											echo "<tr>											                                          <td colspan='2'><p class='text-primary'>Belum Konfirmasi Pembayaran</p></td>                                          											</tr>											<tr>";}											else{											echo"<tr>											                                          <td><p class='text-primary'>Nama Bank</p></td>                                          <td><p class='text-muted'>:&nbsp; $rst[nbank]</p></td>											</tr>											<tr>											                                          <td><p class='text-primary'>No. Rekening</p></td>                                          <td><p class='text-muted'>:&nbsp; $rst[norek]</p></td>											</tr>											<tr>											                                          <td><p class='text-primary'>Jumlah Transfer</p></td>                                          <td><p class='text-muted'>:&nbsp; $rst[jum_tf]</p></td>											</tr>											<tr>											                                          <td><p class='text-primary'>Bukti Transfer</p></td>                                          <td><p class='text-muted'>:&nbsp; <img src='../../../file/$rst[file]' class='img-polaroid' style='width:250px;border:4px solid #DCDCDC;'/></p></td>											</tr>";}																																																																																								echo"<tr>																						</table>											</td>											</tr>	
					     <tr>
